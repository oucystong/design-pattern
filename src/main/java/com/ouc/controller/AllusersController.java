...
import com.ouc.server.AllusersServer;
import com.ouc.server.UserAggregate;
import com.ouc.server.UserIterator;
import com.ouc.server.impl.UserAggregateImpl;
...
public class AllusersController {
    ...
    private static Logger logger = LoggerFactory.getLogger(AllusersController.class);
    ...
    public String goodList(@RequestParam(value = "page", required = false) String page,
                           ModelMap map, HttpSession session, String username, String pwd, String cx) {
        ...
        UserAggregate nowUserList = new UserAggregateImpl();
        for (Allusers allusers:
             list) {
            nowUserList.addUser(allusers);
        }

        UserIterator iterator = nowUserList.getUserIterator();
        while(iterator.hasNext()){
            Allusers allusers = iterator.next();
            allusers.outputToLogFile();
        }
