...
public class db {
    ...
    private String sConnStr = "jdbc:mysql://101.201.57.15:3307/ssmstglxthsg6124afb4?useUnicode=true&characterEncoding=utf-8";

    private Operation addOperation = new SelectOperation();
    private Operation deleteOperation = new DeleteOperation();
    private Operation updateOperation = new UpdateOperation();
    private Observer o1 = new LoggerInfo();
    private Observer o2 = new LoggerWarn();
    private Observer o3 = new LoggerError();
    ...
    public ResultSet executeQuery(String sql) {
        try {
        	addOperation.addObserver(o1);
        	addOperation.addObserver(o2);
        	addOperation.addObserver(o3);
            connect = DriverManager.getConnection(sConnStr, nsa, nmm);
            Statement stmt = connect.createStatement();
            rs = stmt.executeQuery(sql);
            System.out.println(rs);
            addOperation.notice(new Date() + "时执行了一次查询操作");
