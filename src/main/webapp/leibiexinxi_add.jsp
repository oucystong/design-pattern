...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addLeibiexinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加类别信息</td>
						</tr>
...
function hsgcheck() {
		...
		if(leibie==""||(leibie.length<6||leibie.length>12)){
