...
<form action="hyList.do" name="myform" method="post" style="width:100%">
...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7">
    ...
    <td bgcolor='#ebf0f7'>社长</td>
    <td bgcolor='#ebf0f7'>社长姓名</td>
    <td bgcolor='#ebf0f7'>用户名</td>
    <td bgcolor='#ebf0f7'>姓名</td>
    <td bgcolor='#ebf0f7'>电话</td>
    <td bgcolor='#ebf0f7'>学院</td>
    ...
    <td>${u.zhuanye}</td>
                              ...
                              <td align="center"><a href="hyDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="hyList.do?page=1" >首页</a>
             <a href="hyList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="hyList.do?page=${page.page+1 }">下一页</a>
			<a href="hyList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
