...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="custom">
			...
			<dd class="first_dd"><a href="shetuan_add.jsp" target="rightFrame">社团信息添加</a></dd>
			<dd><a href="shetuanList2.do" target="rightFrame">社团信息查询</a></dd>
             <dd><a href="huiyuanList3.do" target="rightFrame">入社会员查询</a></dd>
			 
			 <dd><a href="zhiduList2.do" target="rightFrame">社团制度查询</a></dd>
			 <dd><a href="xiaoxiList2.do" target="rightFrame">社团消息查询</a></dd>
		</dl>
	
		<dl class="channel">
			<dt onClick="changeImage()">入社信息管理<img src="images/left/select_xl01.png"></dt>
		
			<dd><a href="huiyuanList2.do" target="rightFrame">入社信息管理</a></dd>
		</dl>
	
		<!--<dl class="app">
			<dt onClick="changeImage()">社团制度管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="zhidu_add.jsp" target="rightFrame">社团制度添加</a></dd>
			<dd><a href="zhiduList2.do" target="rightFrame">社团制度查询</a></dd>
		</dl>
	-->
		<!--<dl class="cloud">
			<dt onClick="changeImage()">社团消息管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="xiaoxi_add.jsp" target="rightFrame">社团消息添加</a></dd>
			<dd><a href="xiaoxiList2.do" target="rightFrame">社团消息查询</a></dd>
		</dl>-->
