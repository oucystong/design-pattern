...
<jsp:useBean id="code" scope="page" class="com.ouc.util.CheckCode"/>
        ...
        <div class="news_content">
            ...
            <table width="100%" height="302" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                <form action="hsgloginyanzheng.jsp" method="post" name="userlog" id="userlog">
                    <tr>
                        <td height="48" colspan="4" style="padding-left:30px; font-size:20px;"><strong>用户登陆</strong>
                        </td>
                    </tr>
                    <tr>
                        <td width="40" height="28">&nbsp;</td>
                        <td width="240" height="28">用户名:</td>
                        <td height="28" colspan="2"><input name="username" type="text" id="username"
                                                           placeholder="请输入用户名"
                    ...
                    <tr>
                        <td height="28">&nbsp;</td>
                        <td height="28">密码:</td>
                        <td height="28" colspan="2"><input name="pwd" type="password" id="pwd" placeholder="请输入密码"
                                                           style="width:160px; height:40px; border:solid 1px #000000; color:#666666"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="28">&nbsp;</td>
                        <td height="28">验证码:</td>
                        <td width="67" height="28"><input name="pagerandom" type="text" id="pagerandom"
                    ...
                    <tr>
                        ...
                        <td height="38" align="center">&nbsp;</td>
                        <td height="38" colspan="2"><input type="submit" name="Submit" value="登陆"
                                                           onClick="return checklog();" class="button button1"/>
            ...
            <table width="100%" height="300" border="0" align="center" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td height="28" align="center"><input type="button" name="Submit3" value="退出"
                        ...
                        <input type="button" name="Submit22" value="个人后台" onClick="javascript:location.href='main.jsp';"
