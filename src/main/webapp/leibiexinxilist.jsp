...
<div class="center-content">
	<div class="leftbox">
          <div class="c-left">
              <ul><h2>类别信息/<span>Details</span></h2></ul>
              <!--<ol>
                  <li><a href="#">公司新闻</a></li>
                  <li><a href="#">行业动态</a></li>
				  <li><a href="#">公司新闻</a></li>
    ...
    <div class="c-right">
    	<div class="tree-nav">
        	<h2>类别信息</h2>
            <p><a href="index.do">首页</a>/ 类别信息</p>
        </div>
<div class="news_content">
                                
								
<form action="lbxxList.do" name="myform" method="post" style="width:100%">
...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7">
    ...
    <td>${u.shuoming}</td>
                              ...
                              <td align="center"><a href="lbxxDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="lbxxList.do?page=1" >首页</a>
             <a href="lbxxList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="lbxxList.do?page=${page.page+1 }">下一页</a>
			<a href="lbxxList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
