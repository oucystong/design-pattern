...
<form action="zdList.do" name="myform" method="post" style="width:100%">
...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7">
    ...
    <td bgcolor='#ebf0f7'>章节</td>
    <td bgcolor='#ebf0f7'>制度名称</td>
    
    <td bgcolor='#ebf0f7'>登记人</td>
    ...
    <td>${u.dengjiren}</td>
                              ...
                              <td align="center"><a href="zdDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="zdList.do?page=1" >首页</a>
             <a href="zdList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="zdList.do?page=${page.page+1 }">下一页</a>
			<a href="zdList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
